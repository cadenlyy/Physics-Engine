...
extern double fdouble_pendulum_1(double t, std::vector<double>v, Complex_pendulum Pendulum2) {
    // v1, p1, a1, v2, p2, a2
    return (-Pendulum2.Mass2 * Pendulum2.Length2 * v[5] * cos(v[1] - v[4]) + Pendulum2.Mass2 * Pendulum2.Length2 * v[0] * v[3] * sin(v[1] - v[4]) - Pendulum2.Mass2 * Pendulum2.Length2 * pow(v[3], 2) * sin(v[1] - v[4]) - Pendulum2.Mass2 * Pendulum2.Length2 * v[0] * v[3] * sin(v[1] - v[4]) + Pendulum2.Mass * g * sin(v[1]) + Pendulum2.Mass2 * g * sin(v[1])) / (Pendulum2.Mass * Pendulum2.Length + Pendulum2.Mass2 * Pendulum2.Length);
}
